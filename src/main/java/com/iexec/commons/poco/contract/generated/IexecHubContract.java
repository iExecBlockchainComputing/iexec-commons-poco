...
public class IexecHubContract extends Contract {
    ...
    public static List<AccurateContributionEventResponse> getAccurateContributionEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(ACCURATECONTRIBUTION_EVENT, transactionReceipt);
    ...
    public static List<BroadcastAppOrderEventResponse> getBroadcastAppOrderEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(BROADCASTAPPORDER_EVENT, transactionReceipt);
    ...
    public static List<BroadcastDatasetOrderEventResponse> getBroadcastDatasetOrderEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(BROADCASTDATASETORDER_EVENT, transactionReceipt);
    ...
    public static List<BroadcastRequestOrderEventResponse> getBroadcastRequestOrderEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(BROADCASTREQUESTORDER_EVENT, transactionReceipt);
    ...
    public static List<BroadcastWorkerpoolOrderEventResponse> getBroadcastWorkerpoolOrderEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(BROADCASTWORKERPOOLORDER_EVENT, transactionReceipt);
    ...
    public static List<ClosedAppOrderEventResponse> getClosedAppOrderEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(CLOSEDAPPORDER_EVENT, transactionReceipt);
    ...
    public static List<ClosedDatasetOrderEventResponse> getClosedDatasetOrderEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(CLOSEDDATASETORDER_EVENT, transactionReceipt);
    ...
    public static List<ClosedRequestOrderEventResponse> getClosedRequestOrderEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(CLOSEDREQUESTORDER_EVENT, transactionReceipt);
    ...
    public static List<ClosedWorkerpoolOrderEventResponse> getClosedWorkerpoolOrderEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(CLOSEDWORKERPOOLORDER_EVENT, transactionReceipt);
    ...
    public static List<CreateCategoryEventResponse> getCreateCategoryEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(CREATECATEGORY_EVENT, transactionReceipt);
    ...
    public static List<FaultyContributionEventResponse> getFaultyContributionEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(FAULTYCONTRIBUTION_EVENT, transactionReceipt);
    ...
    public static List<LockEventResponse> getLockEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(LOCK_EVENT, transactionReceipt);
    ...
    public static List<OrdersMatchedEventResponse> getOrdersMatchedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(ORDERSMATCHED_EVENT, transactionReceipt);
    ...
    public static List<SchedulerNoticeEventResponse> getSchedulerNoticeEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(SCHEDULERNOTICE_EVENT, transactionReceipt);
    ...
    public static List<SeizeEventResponse> getSeizeEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(SEIZE_EVENT, transactionReceipt);
    ...
    public static List<SignedAppOrderEventResponse> getSignedAppOrderEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(SIGNEDAPPORDER_EVENT, transactionReceipt);
    ...
    public static List<SignedDatasetOrderEventResponse> getSignedDatasetOrderEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(SIGNEDDATASETORDER_EVENT, transactionReceipt);
    ...
    public static List<SignedRequestOrderEventResponse> getSignedRequestOrderEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(SIGNEDREQUESTORDER_EVENT, transactionReceipt);
    ...
    public static List<SignedWorkerpoolOrderEventResponse> getSignedWorkerpoolOrderEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(SIGNEDWORKERPOOLORDER_EVENT, transactionReceipt);
    ...
    public static List<TaskClaimedEventResponse> getTaskClaimedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(TASKCLAIMED_EVENT, transactionReceipt);
    ...
    public static List<TaskConsensusEventResponse> getTaskConsensusEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(TASKCONSENSUS_EVENT, transactionReceipt);
    ...
    public static List<TaskContributeEventResponse> getTaskContributeEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(TASKCONTRIBUTE_EVENT, transactionReceipt);
    ...
    public static List<TaskFinalizeEventResponse> getTaskFinalizeEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(TASKFINALIZE_EVENT, transactionReceipt);
    ...
    public static List<TaskInitializeEventResponse> getTaskInitializeEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(TASKINITIALIZE_EVENT, transactionReceipt);
    ...
    public static List<TaskReopenEventResponse> getTaskReopenEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(TASKREOPEN_EVENT, transactionReceipt);
    ...
    public static List<TaskRevealEventResponse> getTaskRevealEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(TASKREVEAL_EVENT, transactionReceipt);
    ...
    public static List<UnlockEventResponse> getUnlockEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(UNLOCK_EVENT, transactionReceipt);
    ...
    public static class Account extends StaticStruct {
        ...
        public Account(BigInteger stake, BigInteger locked) {
            super(new org.web3j.abi.datatypes.generated.Uint256(stake), 
                    new org.web3j.abi.datatypes.generated.Uint256(locked));
            this.stake = stake;
            this.locked = locked;
        }
    ...
    public static class Category extends DynamicStruct {
        ...
        public Category(String name, String description, BigInteger workClockTimeRef) {
            super(new org.web3j.abi.datatypes.Utf8String(name), 
                    ...
                    new org.web3j.abi.datatypes.generated.Uint256(workClockTimeRef));
            this.name = name;
    ...
    public static class Contribution extends StaticStruct {
        ...
        public Contribution(BigInteger status, byte[] resultHash, byte[] resultSeal, String enclaveChallenge, BigInteger weight) {
            super(new org.web3j.abi.datatypes.generated.Uint8(status), 
                    new org.web3j.abi.datatypes.generated.Bytes32(resultHash), 
                    new org.web3j.abi.datatypes.generated.Bytes32(resultSeal), 
                    new org.web3j.abi.datatypes.Address(enclaveChallenge), 
    ...
    public static class Resource extends StaticStruct {
        ...
        public Resource(String pointer, String owner, BigInteger price) {
            super(new org.web3j.abi.datatypes.Address(pointer), 
    ...
    public static class Task extends DynamicStruct {
        ...
        public Task(BigInteger status, byte[] dealid, BigInteger idx, BigInteger timeref, BigInteger contributionDeadline, BigInteger revealDeadline, BigInteger finalDeadline, byte[] consensusValue, BigInteger revealCounter, BigInteger winnerCounter, List<String> contributors, byte[] resultDigest, byte[] results, BigInteger resultsTimestamp, byte[] resultsCallback) {
            super(new org.web3j.abi.datatypes.generated.Uint8(status), 
                    new org.web3j.abi.datatypes.generated.Bytes32(dealid), 
                    new org.web3j.abi.datatypes.generated.Uint256(idx), 
                    new org.web3j.abi.datatypes.generated.Uint256(timeref), 
                    new org.web3j.abi.datatypes.generated.Uint256(contributionDeadline), 
                    new org.web3j.abi.datatypes.generated.Uint256(revealDeadline), 
                    new org.web3j.abi.datatypes.generated.Uint256(finalDeadline), 
                    new org.web3j.abi.datatypes.generated.Bytes32(consensusValue), 
                    new org.web3j.abi.datatypes.generated.Uint256(revealCounter), 
                    new org.web3j.abi.datatypes.generated.Uint256(winnerCounter), 
                    new org.web3j.abi.datatypes.DynamicArray<org.web3j.abi.datatypes.Address>(
                            org.web3j.abi.datatypes.Address.class,
                            org.web3j.abi.Utils.typeMap(contributors, org.web3j.abi.datatypes.Address.class)), 
                    new org.web3j.abi.datatypes.generated.Bytes32(resultDigest), 
                    new org.web3j.abi.datatypes.DynamicBytes(results), 
                    new org.web3j.abi.datatypes.generated.Uint256(resultsTimestamp), 
                    new org.web3j.abi.datatypes.DynamicBytes(resultsCallback));
            this.status = status;
            this.dealid = dealid;
            this.idx = idx;
    ...
    public static class Deal extends DynamicStruct {
        ...
        public Deal(Resource app, Resource dataset, Resource workerpool, BigInteger trust, BigInteger category, byte[] tag, String requester, String beneficiary, String callback, String params, BigInteger startTime, BigInteger botFirst, BigInteger botSize, BigInteger workerStake, BigInteger schedulerRewardRatio) {
            super(app, 
                    ...
                    new org.web3j.abi.datatypes.generated.Uint256(workerStake), 
                    new org.web3j.abi.datatypes.generated.Uint256(schedulerRewardRatio));
            this.app = app;
            this.dataset = dataset;
            this.workerpool = workerpool;
            this.trust = trust;
